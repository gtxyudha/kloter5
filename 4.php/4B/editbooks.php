        ...
        <div class="row">
            <div class="col-md-6">
                  <div class="formedit">
                    ...
                    $data = $sql->fetch();
                    ?>
                    <form method="post" action="proseseditbooks.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                    <table cellpadding="8">
                        <tr>
                        <td>Name</td>
                        ...
                        <tr>
                            <td>Image</td>
                            <td><img id="uploadPreview" style="width: 150px; height: 150px;" src="image/<?php echo $data['image']?>"><br>
                                <input type="file" id="uploadImage" name="image" onchange="preview_image(event)"></td>
                        </tr>
                        <tr>
                            <td>Deskripsi</td>
                            <td><textarea name="deskripsi" class="form-control" style="width:350px;  height: 150px;"><?php echo $data['deskripsi']; ?></textarea></td>
                        </tr>
                    </table>
                    <hr>
