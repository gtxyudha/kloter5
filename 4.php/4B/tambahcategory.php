...
<head>
  ...
  <!-- Edit Category -->
  <link rel="stylesheet" href="css/tambahcategory.css">
</head>
        ...
        <div class="row">
            <div class="col-md-6">
                    <div class="formtambah">
                        <form method="post" action="prosestambahcategory.php" enctype="multipart/form-data">
                        <table cellpadding="8">
                            <tr>
                            <td>Name</td>
                        ...
                        <a href="category.php"><input type="button" value="Batal" class="btnbatal"></a>
                        </form>
                    </div>
            </div>
        </div>
